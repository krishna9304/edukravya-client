...
function CarouselCard({
  ...
  return (
    <div
      className={`min-w-[calc(100vw-5rem)] hover:scale-110 snap-center lg:min-w-[calc(44vw)] rounded-3xl bg-primary-600 flex duration-300`}
    >
      <div
      ...
      <div className="w-1/2 flex space-x-[-100%]">
        <img
          style={{
            objectFit: "cover",
          }}
